...
copy /Y "%~dp0Logo+RGB MONO.png" "%~dp0bin\receipt-logo.png" >nul
copy /Y "%~dp0src\left-top.png" "%~dp0bin\left-top.png" >nul
copy /Y "%~dp0src\right-top.png" "%~dp0bin\right-top.png" >nul
copy /Y "%~dp0src\left-side.png" "%~dp0bin\left-side.png" >nul
copy /Y "%~dp0src\right-side.png" "%~dp0bin\right-side.png" >nul
